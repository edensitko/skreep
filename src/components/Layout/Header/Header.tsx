          ...
          <div className="flex 2xl:space-x-[100px] xl:space-x-10 justify-center items-center w-full xl:w-auto">
            <div className="flex justify-center items-center">
              <Link href="/" aria-label="logo">
                <Image src="/assets/images/logo-1.webp" alt="Skreep - פתרונות בינה מלאכותית" width={150} height={50} className="w-[150px] md:w-[150px] pt-3 mr-" style={{ width: 'auto', height: 'auto' }} />
              </Link>
            </div>
          </div>
        </div>
