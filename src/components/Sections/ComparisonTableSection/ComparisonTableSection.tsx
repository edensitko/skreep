...
function ComparisonTableSection() {
  ...
  // Get comparison data from translations with fallback
  const comparisonData = useMemo(() => {
    try {
      const data = t('comparisonTable.data');
      return Array.isArray(data) ? data : COMPARISON_DATA;
    } catch {
    ...
    >
      <div className="mx-auto container px-2 py-6">
        ...
        >
          ...
          <div className="grid grid-cols-4" role="row">
            <div 
              ...
              role="columnheader"
            >
              <h3 className="font-light text-red-300 text-sm" dir="ltr">
            ...
            >
              <div className="flex items-center justify-center gap-3">
                <div>
                  <p className="text-white text-md" dir="ltr">
        ...
        <div className="bg-black/40 backdrop-blur-xl mt-10 p-6 md:p-8 text-center rounded-2xl">
          <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-4" dir="ltr">
            <span className="bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent">
              {t('comparisonTable.cta.title')}
            </span>
          </h3>
          <p className="text-gray-300 mb-6 max-w-2xl mx-auto text-base md:text-lg lg:text-xl leading-relaxed" dir="ltr">
            {t('comparisonTable.cta.subtitle')}
          </p>
          ...
          <button 
            ...
            aria-label={t('comparisonTable.cta.buttonAriaLabel')}
            dir="ltr"
          >
            {t('comparisonTable.cta.buttonText')}
          </button>
        </div>
      </div>
