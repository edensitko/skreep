...
const SERVICE_DETAILS: Record<string, ServiceDetail> = {
  ...
  'data-analytics': {
    technologies: [
      ...
      { name: 'MongoDB', logo: TECH_LOGOS.mongodb },
      { name: 'AWS', logo: TECH_LOGOS.aws },
      { name: 'GraphQL', logo: TECH_LOGOS.graphql },
      { name: 'Node.js', logo: TECH_LOGOS.nodejs },
    ],
    fullDescription: {
      he: 'אנו מתמחים ביצירת מערכות ניתוח נתונים מתקדמות שהופכות מידע גולמי לתובנות עסקיות פעילות. הפתרונות שלנו מאפשרים קבלת החלטות מבוססת נתונים בזמן אמת.\n\nאנו בונים דשבורדים אינטראקטיביים שמציגים את המידע החשוב בצורה ברורה וויזואלית.\n\nהכלים שלנו כוללים Power BI, Tableau, ופתרונות מותאמים אישית.',
      en: 'We specialize in creating advanced data analysis systems that turn raw data into actionable business insights. Our solutions enable real-time data-driven decision making.\n\nWe build interactive dashboards that display important information clearly and visually.\n\nOur tools include Power BI, Tableau, and custom solutions.',
    },
    relatedProjects: ['ai-task-organizer', 'ai-chatbot-builder'],
    benefits: {
      he: ['תובנות עסקיות בזמן אמת', 'קבלת החלטות מבוססת נתונים', 'זיהוי הזדמנויות עסקיות', 'חיזוי מגמות עתידיות'],
      en: ['Real-time business insights', 'Data-driven decisions', 'Identify business opportunities', 'Predict future trends'],
    },
    whyChooseUs: {
      he: {
        title: 'למה לבחור בנו לניתוח נתונים ו-BI?',
        reasons: [
          {
            title: 'מומחיות בביג דאטה',
            description: 'ניסיון עם Python, SQL, MongoDB ו-PostgreSQL. יכולת לעבד ולנתח כמויות עצומות של נתונים',
            icon: '📊'
          },
          {
            title: 'דשבורדים אינטראקטיביים',
            description: 'יצירת דשבורדים מותאמים אישית עם ויזואליזציות מתקדמות ותובנות בזמן אמת',
            icon: '📈'
          },
          {
            title: 'בינה עסקית מתקדמת',
            description: 'הפקת תובנות עסקיות מעמיקות שמובילות לשיפור ביצועים והגדלת רווחים',
            icon: '🧠'
          },
          {
            title: 'אוטומציה מלאה',
            description: 'דוחות אוטומטיים, התראות חכמות ומעקב KPI בזמן אמת',
            icon: '⚡'
          }
        ],
        techExpertise: 'אנו משתמשים בכלים המתקדמים ביותר: Python עם Pandas ו-NumPy לעיבוד נתונים, PostgreSQL ו-MongoDB למסדי נתונים, AWS Redshift ו-BigQuery לביג דאטה, GraphQL ל-API מהיר, ו-React לדשבורדים אינטראקטיביים.',
        experience: 'פיתחנו מעל 40 מערכות ניתוח נתונים לחברות בתחומים שונים. מחברות פינטק ועד רשתות קמעונאות - אנו יודעים איך להפוך נתונים לתובנות.'
      },
      en: {
        title: 'Why Choose Us for Data Analytics & BI?',
        reasons: [
          {
            title: 'Big Data Expertise',
            description: 'Experience with Python, SQL, MongoDB, and PostgreSQL. Ability to process and analyze massive amounts of data',
            icon: '📊'
          },
          {
            title: 'Interactive Dashboards',
            description: 'Creating custom dashboards with advanced visualizations and real-time insights',
            icon: '📈'
          },
          {
            title: 'Advanced Business Intelligence',
            description: 'Extracting deep business insights that lead to performance improvement and increased profits',
            icon: '🧠'
          },
          {
            title: 'Full Automation',
            description: 'Automated reports, smart alerts, and real-time KPI tracking',
            icon: '⚡'
          }
        ],
        techExpertise: 'We use the most advanced tools: Python with Pandas and NumPy for data processing, PostgreSQL and MongoDB for databases, AWS Redshift and BigQuery for big data, GraphQL for fast APIs, and React for interactive dashboards.',
        experience: 'We\'ve developed over 40 data analysis systems for companies in various sectors. From fintech companies to retail chains - we know how to turn data into insights.'
      }
    }
  },
  'saas-development': {
